...
namespace LinkShorteningSystem.WebApi.Middlewares
{
    public sealed class GlobalExceptionHandlingMiddleware : IMiddleware
    {
        ...
        /// <exception cref="OriginalLinkNotFoundException">Thrown when the requested event is not found.</exception>
        /// <exception cref="ShortenedLinkNotFoundException">Thrown when the requested sponsor is not found.</exception>
